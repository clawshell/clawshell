...
ENTRYPOINT ["sudo", "env", "CLAWSHELL_OAUTH_CALLBACK_HOST=0.0.0.0", "PATH=$/home/node/nodeenv/bin:/home/node/nodeenv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin", "clawshell"]
